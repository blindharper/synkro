...
void App::Run()
{
	...
	_synkro->GetWindowSystem()->CreateWindow( false, false, L"Clock - Phase 03", 0, _displayModeWindowed.Width, _displayModeWindowed.Height );
...
void App::OnSynkroInitialize()
{
	...
	_dial = new Dial( _synkro, _scene, 15.0f );
}
