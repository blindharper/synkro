...
//
// Purpose: Defines a batch of triangle mesh nodes.
//==============================================================================
#ifndef _SYNKRO_SCENE_ITRIANGLEMESHBATCH_
#define _SYNKRO_SCENE_ITRIANGLEMESHBATCH_
...
public:
	 ...
	 */
	virtual ITriangleMesh*									CreateInstance( INode* parent, const math::Matrix4x4& transform, const img::Color& color ) = 0;
	 ...
	 */
	virtual ITriangleMesh*									GetInstance( UInt index ) const = 0;
...
#endif // _SYNKRO_SCENE_ITRIANGLEMESHBATCH_
