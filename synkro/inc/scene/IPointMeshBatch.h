...
//
// Purpose: Defines a batch of point mesh nodes.
//==============================================================================
#ifndef _SYNKRO_SCENE_IPOINTMESHBATCH_
#define _SYNKRO_SCENE_IPOINTMESHBATCH_
...
public:
	 ...
	 */
	virtual IPointMesh*										CreateInstance( INode* parent, const math::Matrix4x4& transform, const img::Color& color ) = 0;
	 ...
	 */
	virtual IPointMesh*										GetInstance( UInt index ) const = 0;
...
#endif // _SYNKRO_SCENE_IPOINTMESHBATCH_
