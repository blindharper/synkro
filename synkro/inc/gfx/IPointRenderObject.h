...
//
// Purpose: Defines point rendering object.
//==============================================================================
#ifndef _SYNKRO_GFX_IPOINTRENDEROBJECT_
#define _SYNKRO_GFX_IPOINTRENDEROBJECT_
...
public:
	 ...
	 */
	virtual IPointRenderQueue*								GetQueue() const = 0;
};
...
#endif // _SYNKRO_GFX_IPOINTRENDEROBJECT_
