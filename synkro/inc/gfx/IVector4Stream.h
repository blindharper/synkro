...
//
// Purpose: Defines stream of 4-component vectors.
//==============================================================================
#ifndef _SYNKRO_GFX_IVECTOR4STREAM_
#define _SYNKRO_GFX_IVECTOR4STREAM_
...
public:
	 ...
	 */
	virtual void											Read( math::Vector4* data, UInt count ) = 0;
	 ...
	 */
	virtual void											Write( const math::Vector4* data, UInt count ) = 0;
...
#endif // _SYNKRO_GFX_IVECTOR4STREAM_
