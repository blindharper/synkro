...
//
// Purpose: Defines stream of 3-component vectors.
//==============================================================================
#ifndef _SYNKRO_GFX_IVECTOR3STREAM_
#define _SYNKRO_GFX_IVECTOR3STREAM_
...
public:
	 ...
	 */
	virtual void											Read( math::Vector3* data, UInt count ) = 0;
	 ...
	 */
	virtual void											Write( const math::Vector3* data, UInt count ) = 0;
...
#endif // _SYNKRO_GFX_IVECTOR3STREAM_
