...
//==============================================================================
#ifndef _SYNKRO_GFX_IMATRIX4X4STREAM_
#define _SYNKRO_GFX_IMATRIX4X4STREAM_
...
public:
	 ...
	 */
	virtual void											Read( math::Matrix4x4* data, UInt count ) = 0;
	 ...
	 */
	virtual void											Write( const math::Matrix4x4* data, UInt count ) = 0;
...
#endif // _SYNKRO_GFX_IMATRIX4X4STREAM_
