...
//
// Purpose: Defines plain texture.
//==============================================================================
#ifndef _SYNKRO_GFX_IPLAINTEXTURE_
#define _SYNKRO_GFX_IPLAINTEXTURE_
...
public:
	 ...
	 */
	virtual Bool											SetData( UInt element, UInt level, UInt width, UInt height, UInt stride, const img::PixelFormat& format, const Byte* data ) = 0;
...
#endif // _SYNKRO_GFX_IPLAINTEXTURE_
