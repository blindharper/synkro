...
//
// Purpose: Defines keyframed animation track for a size value.
//==============================================================================
#ifndef _SYNKRO_ANIM_IKEYFRAMEDSIZETRACK_
#define _SYNKRO_ANIM_IKEYFRAMEDSIZETRACK_


#include "config.h"
#include <anim/IAnimationSizeTrack.h>
...
/**
 * Keyframed animation track for a size value.
 */
iface IKeyframedSizeTrack :
	public IAnimationSizeTrack
{
public:
	/**
	 ...
	 */
	virtual void											SetKey( Double time, const lang::Size& value, const Interpolation& interpolation ) = 0;
	 ...
	 * @param value Key value.
	 */
	virtual void											SetKey( Double time, const lang::Size& value ) = 0;
	 ...
	 * @exception OutOfRangeException Index is out of range.
	 */
	virtual void											GetKeyValue( UInt index, lang::Size& value ) const = 0;
};
...
#endif // _SYNKRO_ANIM_IKEYFRAMEDSIZETRACK_
