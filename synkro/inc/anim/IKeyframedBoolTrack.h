...
//
// Purpose: Defines keyframed animation track for a boolean value.
//==============================================================================
#ifndef _SYNKRO_ANIM_IKEYFRAMEDBOOLTRACK_
#define _SYNKRO_ANIM_IKEYFRAMEDBOOLTRACK_


#include "config.h"
#include <anim/IAnimationBoolTrack.h>
...
/**
 * Keyframed animation track for a boolean value.
 */
iface IKeyframedBoolTrack :
	public IAnimationBoolTrack
{
public:
	/**
	 ...
	 */
	virtual void											SetKey( Double time, const Bool& value, const Interpolation& interpolation ) = 0;
	 ...
	 * @param value Key value.
	 */
	virtual void											SetKey( Double time, const Bool& value ) = 0;
	 ...
	 * @exception OutOfRangeException Index is out of range.
	 */
	virtual void											GetKeyValue( UInt index, Bool& value ) const = 0;
};
...
#endif // _SYNKRO_ANIM_IKEYFRAMEDBOOLTRACK_
