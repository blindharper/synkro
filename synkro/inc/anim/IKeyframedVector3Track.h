...
//
// Purpose: Defines keyframed animation track for a 3-component vector.
//==============================================================================
#ifndef _SYNKRO_ANIM_IKEYFRAMEDVECTOR3TRACK_
#define _SYNKRO_ANIM_IKEYFRAMEDVECTOR3TRACK_
...
/**
 * Keyframed animation track for a 3-component vector.
 */
...
public:
	 ...
	 */
	virtual void											SetKey( Double time, const math::Vector3& value, const Interpolation& interpolation ) = 0;
	 ...
	 * @param value Key value.
	 */
	virtual void											SetKey( Double time, const math::Vector3& value ) = 0;
	 ...
	 * @exception OutOfRangeException Index is out of range.
	 */
	virtual void											GetKeyValue( UInt index, math::Vector3& value ) const = 0;
};
...
#endif // _SYNKRO_ANIM_IKEYFRAMEDVECTOR3TRACK_
