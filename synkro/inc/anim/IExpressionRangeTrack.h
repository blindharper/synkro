...
//
// Purpose: Defines expression track for a range value.
//==============================================================================
#ifndef _SYNKRO_ANIM_IEXPRESSIONRANGETRACK_
#define _SYNKRO_ANIM_IEXPRESSIONRANGETRACK_
...
/**
 * Expression track for a range value.
 */
...
#endif // _SYNKRO_ANIM_IEXPRESSIONRANGETRACK_
