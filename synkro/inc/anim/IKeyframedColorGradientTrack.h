...
//
// Purpose: Defines keyframed animation track for a color gradient value.
//==============================================================================
#ifndef _SYNKRO_ANIM_IKEYFRAMEDCOLORGRADIENTTRACK_
#define _SYNKRO_ANIM_IKEYFRAMEDCOLORGRADIENTTRACK_
...
/**
 * Keyframed animation track for a color gradient value.
 */
...
public:
	 ...
	 */
	virtual void											SetKey( Double time, const img::ColorGradient& value, const Interpolation& interpolation ) = 0;
	 ...
	 * @param value Key value.
	 */
	virtual void											SetKey( Double time, const img::ColorGradient& value ) = 0;
	 ...
	 * @exception OutOfRangeException Index is out of range.
	 */
	virtual void											GetKeyValue( UInt index, img::ColorGradient& value ) const = 0;
};
...
#endif // _SYNKRO_ANIM_IKEYFRAMEDCOLORGRADIENTTRACK_
