...
//
// Purpose: Defines expression track for a floating-point value.
//==============================================================================
#ifndef _SYNKRO_ANIM_IEXPRESSIONFLOATTRACK_
#define _SYNKRO_ANIM_IEXPRESSIONFLOATTRACK_
...
/**
 * Expression track for a floating-point value.
 */
...
#endif // _SYNKRO_ANIM_IEXPRESSIONFLOATTRACK_
