...
//
// Purpose: Defines keyframed animation track for a point value.
//==============================================================================
#ifndef _SYNKRO_ANIM_IKEYFRAMEDPOINTTRACK_
#define _SYNKRO_ANIM_IKEYFRAMEDPOINTTRACK_
...
/**
 * Keyframed animation track for a point value.
 */
iface IKeyframedPointTrack :
	public IAnimationPointTrack
{
public:
	/**
	 ...
	 */
	virtual void											SetKey( Double time, const lang::Point& value, const Interpolation& interpolation ) = 0;
	 ...
	 * @param value Key value.
	 */
	virtual void											SetKey( Double time, const lang::Point& value ) = 0;
	 ...
	 * @exception OutOfRangeException Index is out of range.
	 */
	virtual void											GetKeyValue( UInt index, lang::Point& value ) const = 0;
};
...
#endif // _SYNKRO_ANIM_IKEYFRAMEDPOINTTRACK_
