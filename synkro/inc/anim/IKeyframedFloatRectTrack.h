...
//
// Purpose: Defines keyframed animation track for a floating-point rectangular value.
//==============================================================================
#ifndef _SYNKRO_ANIM_IKEYFRAMEDFLOATRECTTRACK_
#define _SYNKRO_ANIM_IKEYFRAMEDFLOATRECTTRACK_


#include "config.h"
#include <anim/IAnimationFloatRectTrack.h>
...
/**
 * Keyframed animation track for a floating-point rectangular value.
 */
iface IKeyframedFloatRectTrack :
	public IAnimationFloatRectTrack
{
public:
	/**
	 ...
	 */
	virtual void											SetKey( Double time, const lang::RectF& value, const Interpolation& interpolation ) = 0;
	 ...
	 * @param value Key value.
	 */
	virtual void											SetKey( Double time, const lang::RectF& value ) = 0;
	 ...
	 * @exception OutOfRangeException Index is out of range.
	 */
	virtual void											GetKeyValue( UInt index, lang::RectF& value ) const = 0;
};
...
#endif // _SYNKRO_ANIM_IKEYFRAMEDFLOATRECTTRACK_
