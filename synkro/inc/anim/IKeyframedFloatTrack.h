...
//
// Purpose: Defines keyframed animation track for a floating-point value.
//==============================================================================
#ifndef _SYNKRO_ANIM_IKEYFRAMEDFLOATTRACK_
#define _SYNKRO_ANIM_IKEYFRAMEDFLOATTRACK_
...
/**
 * Keyframed animation track for a floating-point value.
 */
...
public:
	 ...
	 */
	virtual void											SetKey( Double time, const Float& value, const Interpolation& interpolation ) = 0;
	 ...
	 * @param value Key value.
	 */
	virtual void											SetKey( Double time, const Float& value ) = 0;
	 ...
	 * @exception OutOfRangeException Index is out of range.
	 */
	virtual void											GetKeyValue( UInt index, Float& value ) const = 0;
};
...
#endif // _SYNKRO_ANIM_IKEYFRAMEDFLOATTRACK_
