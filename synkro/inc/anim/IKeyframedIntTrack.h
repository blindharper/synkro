...
//
// Purpose: Defines keyframed animation track for a whole-number value.
//==============================================================================
#ifndef _SYNKRO_ANIM_IKEYFRAMEDINTTRACK_
#define _SYNKRO_ANIM_IKEYFRAMEDINTTRACK_
...
/**
 * Keyframed animation track for a whole-number value.
 */
...
public:
	 ...
	 */
	virtual void											SetKey( Double time, const Int& value, const Interpolation& interpolation ) = 0;
	 ...
	 * @param value Key value.
	 */
	virtual void											SetKey( Double time, const Int& value ) = 0;
	 ...
	 * @exception OutOfRangeException Index is out of range.
	 */
	virtual void											GetKeyValue( UInt index, Int& value ) const = 0;
};
...
#endif // _SYNKRO_ANIM_IKEYFRAMEDINTTRACK_
