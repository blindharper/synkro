...
//
// Purpose: Defines keyframed animation track for a 4x4 matrix.
//==============================================================================
#ifndef _SYNKRO_ANIM_IKEYFRAMEDMATRIX4X4TRACK_
#define _SYNKRO_ANIM_IKEYFRAMEDMATRIX4X4TRACK_
...
/**
 * Keyframed animation track for a 4x4 matrix.
 */
...
public:
	 ...
	 */
	virtual void											SetKey( Double time, const math::Matrix4x4& value, const Interpolation& interpolation ) = 0;
	 ...
	 * @param value Key value.
	 */
	virtual void											SetKey( Double time, const math::Matrix4x4& value ) = 0;
	 ...
	 * @exception OutOfRangeException Index is out of range.
	 */
	virtual void											GetKeyValue( UInt index, math::Matrix4x4& value ) const = 0;
};
...
#endif // _SYNKRO_ANIM_IKEYFRAMEDMATRIX4X4TRACK_
