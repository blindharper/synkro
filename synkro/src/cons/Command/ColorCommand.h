...
//==============================================================================
#ifndef _SYNKRO_CONS_COLORCOMMAND_
#define _SYNKRO_CONS_COLORCOMMAND_
...
{
public:
	ColorCommand( IConsole* console, const lang::String& description, const lang::String& syntax );
...
#endif // _SYNKRO_CONS_COLORCOMMAND_
