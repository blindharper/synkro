...
//==============================================================================
#ifndef _SYNKRO_CONS_ECHOCOMMAND_
#define _SYNKRO_CONS_ECHOCOMMAND_
...
{
public:
	EchoCommand( IConsole* console, const lang::String& description, const lang::String& syntax );
...
#endif // _SYNKRO_CONS_ECHOCOMMAND_
