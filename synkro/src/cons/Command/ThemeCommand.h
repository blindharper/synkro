...
//==============================================================================
#ifndef _SYNKRO_CONS_THEMECOMMAND_
#define _SYNKRO_CONS_THEMECOMMAND_
...
{
public:
	ThemeCommand( IConsole* console, const lang::String& description, const lang::String& syntax );
...
#endif // _SYNKRO_CONS_THEMECOMMAND_
