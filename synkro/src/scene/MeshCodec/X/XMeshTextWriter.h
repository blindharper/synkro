...
//==============================================================================
#ifndef _SYNKRO_SCENE_XMESHTEXTWRITER_
#define _SYNKRO_SCENE_XMESHTEXTWRITER_
...
// Text DirectX mesh writer.
class XMeshTextWriter :
...
private:
	...
	void													WriteFaces( const lang::Vector<UInt>& array );
...
#endif // _SYNKRO_SCENE_XMESHTEXTWRITER_
