...
//==============================================================================
template <class T>
SYNKRO_INLINE Kernel3x3FilterAnimationControllerImpl<T>::Kernel3x3FilterAnimationControllerImpl( IKernel3x3Filter* kernel3x3Filter, anim::IAnimationSystem* animationSystem, anim::IAnimationSet* animations, anim::AnimationListener* listener ) :
	ViewportFilterAnimationControllerImpl<T>( kernel3x3Filter, animationSystem, animations, listener ),
	_kernel3x3Filter( kernel3x3Filter ),
	_trackPassCount( nullptr )
{
}
...
SYNKRO_INLINE void Kernel3x3FilterAnimationControllerImpl<T>::Update( Double delta )
{
	...
	{
		Int count;
		_trackPassCount->GetValue( CurrentTime(), count );
...
{
	return (_trackPassCount = _animations->GetActiveAnimation()->CreateIntTrack(Kernel3x3FilterProperty::PassCount.ToString()))->AsKeyframed();
}
...
template <class T>
SYNKRO_INLINE void Kernel3x3FilterAnimationControllerImpl<T>::UpdateTracks()
{
	// Call base implementation.
	ViewportFilterAnimationControllerImpl<T>::UpdateTracks();
