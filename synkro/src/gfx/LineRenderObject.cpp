...
LineRenderObject::LineRenderObject( LineRenderQueue* queue, IPrimitive* data ) :
	RenderObjectImpl<ILineRenderObject>( data->GetProgram() ),
	_queue( queue ),
	_startElement( 0 ),
...
void LineRenderObject::SetElementRange( UInt start, UInt count )
{
...
void LineRenderObject::SetInstanceRange( UInt start, UInt count )
{
