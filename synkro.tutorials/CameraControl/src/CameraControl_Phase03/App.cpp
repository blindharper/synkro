...
void App::Run()
{
	...
	_synkro->GetWindowSystem()->CreateWindow( false, false, L"Camera Control - Phase03", 0, _displayModeWindowed.Width, _displayModeWindowed.Height );
...
void App::InitScene()
{
	...
	// Create sound source.
	PtrStream streamSound = GetStream( L"MusicMono.wav" );
