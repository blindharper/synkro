...
public:
	...
	void Configure( IConfiguration* config ) override
	{
		...
		config->Set( Param::StreamPath, String(L"..\\..\\..\\models") );
	}
...
{
	SynkroMemoryInit( "memmgr", true, "MeshViewer.mem", false, true );
	SynkroProfileInit( "profiler", true, "MeshViewer.prf", false, true );
