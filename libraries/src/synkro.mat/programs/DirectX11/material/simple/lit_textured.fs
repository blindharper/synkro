//------------------------------------------------------------------------------
// File: lit_textured.fs
//
// Purpose: Fragment shader for lit & textured simple material
//------------------------------------------------------------------------------
#include "../scene.fsh"
...
float4 main( Fragment fragment ) : SV_TARGET
{
	...
	float4 diffuse = (sp_amountDiffuse > 0.0f) ? sp_amountDiffuse*texDiffuse.Sample(samDiffuse, tex) * fragment.diffuse + fragment.specular : fragment.diffuse + fragment.specular;
