...
SYNKRO_EXTERN_C INSTRUMENT_API void SynkroPrfInitialize( synkro::Bool expand )
{
	synkro::prf::StdProfiler::Initialize( expand );
}

SYNKRO_EXTERN_C INSTRUMENT_API void SynkroPrfBegin( const char* name, synkro::Bool collapse )
{
	synkro::prf::StdProfiler::BeginProfile( name, collapse );
}

SYNKRO_EXTERN_C INSTRUMENT_API void SynkroPrfEnd()
{
	synkro::prf::StdProfiler::EndProfile();
}

SYNKRO_EXTERN_C INSTRUMENT_API void SynkroPrfSaveReport( const char* filename, synkro::Bool accumulate, synkro::Bool plain )
{
