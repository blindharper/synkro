...
SYNKRO_EXTERN_C INSTRUMENT_API void SynkroMemInitialize( synkro::Bool showLines )
{
	_showLines = showLines;
}

SYNKRO_EXTERN_C INSTRUMENT_API void* SynkroMemAllocate( synkro::UInt size, const char* file, synkro::UInt line )
{
	char name[260] = {};
...
SYNKRO_EXTERN_C INSTRUMENT_API void SynkroMemFree( void* ptr, synkro::UInt size )
{
	synkro::mem::StdMemoryManager::Free( ptr );
}

SYNKRO_EXTERN_C INSTRUMENT_API void SynkroMemGetStats( synkro::UInt* stats, synkro::UInt count )
{
...
SYNKRO_EXTERN_C INSTRUMENT_API void SynkroMemSaveReport( const char* filename, synkro::Bool leaksOnly, synkro::Bool plain )
{
